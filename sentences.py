""" This is a module with lists which contains the sentences for typing test """
...
sentence_list = ["The quick brown fox jumps over the lazy dog.",
                ...
                "Those who forget history condemned to repeat it.",
                ...
                "Those diamonds and rubies will make a beatiful piece of jewelry.",
                "The steamboats seemed to float down the Mississippi River at a snail's pace.",
                "A bird in the hand is worth two in the bush.",
                "Caught between a rock and a hard place.",
                "Closing the bartn door after the horse escapes.",
                "Do I look like a turnip that just fell of the turnip truck?",
